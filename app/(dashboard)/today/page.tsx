...
import { RecoveryDetail } from "@/components/dashboard/sections/recovery-detail";
...
import { formatZonedWeekdayShortMonthDay } from "@/lib/format-zoned";
...
export default async function TodayPage({
  ...
  return (
    <div className="space-y-8">
      <div>
        <p className="text-sm tracking-widest text-stone-500 uppercase">Today</p>
        <h1 className="mt-2 text-3xl font-semibold tracking-tight text-stone-900">
          {greeting}, {firstName}
        </h1>
        <p className="mt-2 text-base leading-relaxed text-stone-600">
          Your readiness and this week at a glance.
        </p>
      </div>
        ...
        <summary className="flex cursor-pointer list-none items-center justify-between gap-3 select-none">
          <div>
            ...
            <div className="text-xs text-stone-500">
              WHOOP recovery, HRV, sleep, and resting HR · last 30 days
            </div>
          </div>
